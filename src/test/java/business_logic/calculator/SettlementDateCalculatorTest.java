...
public class SettlementDateCalculatorTest {
    ...
    @Before
    public void setup() {
        settlementDateCalculator = ApplicationFactory.getInstance().getInstructionSettlementDateCalculator();
    }
    ...
    public void calculateSettlementDate_default_Friday() throws Exception {
        ...
        settlementDateCalculator.updateSettlementDate(fakeInstruction);
