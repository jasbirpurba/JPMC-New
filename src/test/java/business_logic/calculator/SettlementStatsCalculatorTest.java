...
public class SettlementStatsCalculatorTest {
    ...
    @Before
    public void setup() {
        final ApplicationFactory applicationFactory = ApplicationFactory.getInstance();
        settlementDateCalculator = applicationFactory.getInstructionSettlementDateCalculator();
        settlementStatsCalculator = applicationFactory.getInstructionSettlementStatsCalculator();
    }

    private Set<Instruction> getFakeSetOfInstructions() {
    ...
    public void testDailyIncomingAmount() throws Exception {
        final Map<LocalDate, BigDecimal> dailyIncomingAmount =
                settlementStatsCalculator.calculateDailyIncomingAmount(getFakeSetOfInstructions());
    ...
    public void testDailyOutgoingAmount() throws Exception {
        final Map<LocalDate, BigDecimal> dailyOutgoingAmount =
                settlementStatsCalculator.calculateDailyOutgoingAmount(getFakeSetOfInstructions());
...
//        assertTrue(Objects.equals(dailyOutgoingAmount.get(WEDNESDAY), BigDecimal.valueOf(700.00).setScale(2, BigDecimal.ROUND_HALF_EVEN)));
    ...
    public void testDailyIncomingRanking() throws Exception {
        final Map<LocalDate, LinkedList<Rank>> dailyIncomingRanking =
                settlementStatsCalculator.calculateDailyIncomingRanking(getFakeSetOfInstructions());
    ...
    public void testDailyOutgoingRanking() throws Exception {
        final Map<LocalDate, LinkedList<Rank>> dailyOutgoingRanking =
                settlementStatsCalculator.calculateDailyOutgoingRanking(getFakeSetOfInstructions());
